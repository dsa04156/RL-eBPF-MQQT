...
RUN_ID=quick_test_$(date +%H%M%S)
echo "🚀 30초 완전 자동화 테스트 $RUN_ID 시작"
...
cat > ~/mqtt-ebpf-edge/results/generated/$RUN_ID/metadata.json << EOF
{
    ...
    "experiment_type": "quick_automated_test",
    "experiment_config": {
...
echo ""
echo "🚀 완전 자동화 테스트 성공! PPO 학습 준비 완료!"
